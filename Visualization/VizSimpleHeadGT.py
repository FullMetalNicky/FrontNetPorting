...
def Viz4PoseVariables(frames, labels):
...
def main():
    ...
    [x_test, y_test] = DataProcessor.ProcessTestData(DATA_PATH + "patterns.pickle", 60, 108, True)
    #x_test = x_test[:500]
    #y_test = y_test[:500]
