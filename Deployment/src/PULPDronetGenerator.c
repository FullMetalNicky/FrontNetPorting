...
/* --------------------------------- LAYER 1 -------------------------------- */
	...
	LargeParOutFeatConvolutionPoolReLU_Hor_fp(
		...
		inWidth[0],								// Width:		Feature Map Width
		inHeight[0],							// Height:		Feature Map Height
...
/* --------------------------------- LAYER 2 -------------------------------- */
	...
	* 32 input planes [50x50], 32 output planes [25x25] */
	MediumParOutFeatConvolutionPoolReLU_fp(
		...
		inWidth[2],								// Width:		Feature Map Width
		inHeight[2],							// Height:		Feature Map Height
...
/* --------------------------------- LAYER 3 -------------------------------- */
	...
	MediumParOutFeatConvolutionPoolReLU_fp(
		...
		inWidth[3],								// Width:		Feature Map Width
		inHeight[3],							// Height:		Feature Map Height
		3,										// FSc:			Filter Selection (1x1, 3x3, 5x5)
...
/* --------------------------------- LAYER 4 -------------------------------- */
	...
	MediumParOutFeatConvolutionPoolReLU_fp(
		...
		inWidth[4],								// Width:		Feature Map Width
		inHeight[4],							// Height:		Feature Map Height
...
/* -------------------------------- ADD RES 1 ------------------------------- */
	...
	CNN_MatrixAdd_SW_fp(
		...
		inWidth[5],								// Width:		Feature Map Width
		inHeight[5]);							// Height:		Feature Map Height
...
/* --------------------------------- LAYER 5 -------------------------------- */
	...
	CNN_ReLu_SW_fp(
		...
		inWidth[6],								// Width:		Feature Map Width
		inHeight[6]);							// Height:		Feature Map Height
	...
	MediumParOutFeatConvolutionPoolReLU_fp(
		...
		inWidth[7],								// Width:		Feature Map Width
		inHeight[7],							// Height:		Feature Map Height
		3,										// FSc:			Filter Selection (1x1, 3x3, 5x5)
		2,										// ConvStride:	Convolution Stride (\1, \2) 
		1,										// ConvDoPad:	Padded Convolution (yes=1, no=0)
		1,										// ConvDoReLU:	ReLu after Convolution (yes=1, no=0)
...
/* --------------------------------- LAYER 6 -------------------------------- */
	...
	MediumParOutFeatConvolutionPoolReLU_fp(
		...
		inWidth[8],								// Width:		Feature Map Width
		inHeight[8],							// Height:		Feature Map Height
		3,										// FSc:			Filter Selection (1x1, 3x3, 5x5)
		1,										// ConvStride:	Convolution Stride (\1, \2) 
		1,										// ConvDoPad:	Padded Convolution (yes=1, no=0)
		0,										// ConvDoReLU:	ReLu after Convolution (yes=1, no=0)
...
/* --------------------------------- LAYER 7 -------------------------------- */
	...
	MediumParOutFeatConvolutionPoolReLU_fp(
		...
		inWidth[9],								// Width:		Feature Map Width
		inHeight[9],							// Height:		Feature Map Height
		1,										// FSc:			Filter Selection (1x1, 3x3, 5x5)
		2,										// ConvStride:	Convolution Stride (\1, \2) 
		0,										// ConvDoPad:	Padded Convolution (yes=1, no=0)
		0,										// ConvDoReLU:	ReLu after Convolution (yes=1, no=0)
...
/* -------------------------------- ADD RES 2 ------------------------------- */
	...
	CNN_MatrixAdd_SW_fp(
		...
		inWidth[10],							// Width:		Feature Map Width
		inHeight[10]);							// Height:		Feature Map Height
...
/* --------------------------------- LAYER 8 -------------------------------- */
	...
	CNN_ReLu_SW_fp(
		...
		inWidth[11],							// Width:		Feature Map Width
		inHeight[11]);							// Height:		Feature Map Height
	...
	MediumParOutFeatConvolutionPoolReLU_fp(
		...
		inWidth[12],							// Width:		Feature Map Width
		inHeight[12],							// Height:		Feature Map Height
		3,										// FSc:			Filter Selection (1x1, 3x3, 5x5)
		2,										// ConvStride:	Convolution Stride (\1, \2) 
		1,										// ConvDoPad:	Padded Convolution (yes=1, no=0)
		1,										// ConvDoReLU:	ReLu after Convolution (yes=1, no=0)
...
/* --------------------------------- LAYER 9 -------------------------------- */
	...
	MediumParOutFeatConvolutionPoolReLU_fp(
		...
		inWidth[13],							// Width:		Feature Map Width
		inHeight[13],							// Height:		Feature Map Height
		3,										// FSc:			Filter Selection (1x1, 3x3, 5x5)
		1,										// ConvStride:	Convolution Stride (\1, \2) 
		1,										// ConvDoPad:	Padded Convolution (yes=1, no=0)
		0,										// ConvDoReLU:	ReLu after Convolution (yes=1, no=0)
...
/* -------------------------------- LAYER 10 -------------------------------- */
	...
	MediumParOutFeatConvolutionPoolReLU_fp(
		...
		inWidth[14],							// Width:		Feature Map Width
		inHeight[14],							// Height:		Feature Map Height
		1,										// FSc:			Filter Selection (1x1, 3x3, 5x5)
		2,										// ConvStride:	Convolution Stride (\1, \2) 
		0,										// ConvDoPad:	Padded Convolution (yes=1, no=0)
		0,										// ConvDoReLU:	ReLu after Convolution (yes=1, no=0)
...
/* -------------------------------- ADD RES 3 ------------------------------- */
	...
	CNN_MatrixAddReLu_SW_fp(
		...
		inWidth[15],							// Width:		Feature Map Width
		inHeight[15]);							// Height:		Feature Map Height
...
/* --------------------------------- DENSE 1 -------------------------------- */
	...
	CNN_TiledLinearLayer(
		...
		inWidth[16],							// Width:		Feature Map Width
		inHeight[16],							// Height:		Feature Map Height
		1,										// ModeSize:	
